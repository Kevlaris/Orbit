...
public class GravityBodyEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (showDebugInfo)
        {
            string[] gravityInfo = GetGravityInfo(gravityObject.transform.position, gravityObject as Attractor);
    ...
    static string[] GetGravityInfo(Vector3 point, Attractor ignore = null)
    {
        Attractor[] bodies = GameObject.FindObjectsOfType<Attractor>();
